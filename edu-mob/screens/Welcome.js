...
import { Animated, Dimensions, Image, FlatList, Modal, StyleSheet, ScrollView, Alert } from 'react-native';
...
const GoogleAndroidId = '730844057336-j04q7fia9euj1fvfgh93l7s89vb3ttas.apps.googleusercontent.com';
const GoogleExpoId = '730844057336-f3qji8ilvgftue1d1gfonintoqoigdob.apps.googleusercontent.com';
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Image
            source={item.source}
            resizeMode="contain"
            style={{ width, height: height / 2.8, overflow: 'visible', marginTop: theme.sizes.base }}
          />
        )}
        onScroll={
          Animated.event([{
    ...
    return (
      <Block>
        ...
        <Block middle flex={1} margin={[0, theme.sizes.padding]}>
          <Button color={theme.colors.accent} onPress={this.loginWithGoogle.bind(this)}>
            <Text center semibold white>Login with Google</Text>
          </Button>
          <Button color={'#29487d'} onPress={this.loginWithFacebook.bind(this)}>
            <Text center semibold white>Login with Facebook</Text>
          </Button>
          <Button gradient onPress={() => navigation.navigate('Login')}>
            <Text center semibold white>Login using Mobile</Text>
          </Button>
          <Button shadow onPress={() => navigation.navigate('SignUp')}>
            <Text center semibold>Signup using Mobile</Text>
          </Button>
